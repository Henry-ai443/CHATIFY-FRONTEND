            ...
            <div className="w-full md:w-1/2 p-4 xs:p-5 sm:p-6 md:p-8 flex flex-col items-center justify-center md:border-r border-slate-600/30">
              <div className="w-full max-w-sm">
                ...
                <div className="text-center mb-5 xs:mb-6 sm:mb-7 md:mb-8">
                  ...
                  <h2 className="text-lg xs:text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-slate-200 mb-1 xs:mb-2 sm:mb-3 leading-tight">Create Account</h2>
                  <p className="text-xs xs:text-sm sm:text-base text-slate-400">Sign up for a new account</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-3 xs:space-y-4 sm:space-y-5 md:space-y-6">
                  ...
                  {/* SUBMIT BUTTON */}
                  <button className="auth-btn mt-2 xs:mt-3 sm:mt-4" type="submit" disabled={isSigningUp}>
                    {isSigningUp ? (
                ...
                <div className="mt-3 xs:mt-4 sm:mt-5 md:mt-6 text-center">
                  <p className="text-xs xs:text-sm text-slate-500 mb-2">Already have an account?</p>
                  <Link to="/login" className="auth-link text-xs xs:text-sm sm:text-base inline-block">
                    Login Here
                  </Link>
                </div>
              </div>
            ...
            <div className="hidden md:flex md:w-1/2 items-center justify-center p-4 md:p-6 lg:p-8 bg-gradient-to-bl from-slate-800/20 to-transparent">
              <div className="w-full flex flex-col items-center justify-center">
                ...
                <div className="mt-4 md:mt-5 lg:mt-6 text-center w-full px-2">
                  <h3 className="text-base md:text-lg lg:text-xl font-medium text-cyan-400 leading-tight">Start Your Journey Today</h3>
